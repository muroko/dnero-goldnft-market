...
!developmentChains.includes(network.name)
  ? describe.skip
  : describe("DGNM market Auction Logic Unit Tests", () => {
      let owner;
      let nftContract;
      ...
      describe("startAuction()", () => {
        ...
        it("should revert if startTime is less or equal to endTime", async () => {
          ...
          await expect(
            ...
            marketContract,
            "DGNMMarket_InvalidAuctionPeriod"
          );
        });
        ...
        it("should revert if directBuyPrice is less than startPrice", async () => {
          ...
          await expect(
            ...
            marketContract,
            "DGNMMarket_InvalidDirectBuyPrice"
          );
        });
      });
      describe("bid()", () => {
        ...
        describe("Auction with no bidders", () => {
          ...
          it("should not allow auction end before endTime", async () => {
            await expect(
              ...
              marketContract,
              "DGNMMarket_AuctionPeriodNotEnded"
            );
          });
