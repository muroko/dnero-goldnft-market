...
!developmentChains.includes(network.name)
  ? describe.skip
  : describe("DGNM Collectors Profile contract Unit Tests", () => {
      let owner;
      let contract;
      ...
      describe("Correct Deployement", () => {
        before(async () => {
          ...
          contract = await deployContract("DGNMCollectors", []);
        });
      ...
      describe("Core Functions", () => {
        ...
        describe("update()", () => {
          ...
          it("should revert if a user tries to update another user profile", async () => {
            ...
            ).to.be.revertedWithCustomError(contract, "DGNM__OnlyTokenOwner");
          });
        ...
        describe("ERC721 Transfer functions", () => {
          ...
          it("All transfer functions should always revert", async () => {
            ...
            ).to.be.revertedWithCustomError(contract, "DGNM__NotTransferable");
            await expect(
              contract
                .connect(user1)
