                  ...
                  <div className="row">
                    <div className="col-lg-4">
                      <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <p className="lead mb-0">
                          Easily trade or hold your Dnero Gold NFTs
                          on our platform
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4">
                      <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h4>NFT Sales</h4>
                        <p className="lead mb-0">
                          Buy and sell unique Dnero Gold NFTs securely on our
                          marketplace.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-4">
                      <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <p className="lead mb-0">
                          Create and mint your personalized collector profile NFT.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4">
                      <div className="features-icons-item mx-auto mb-0 mb-lg-3">
                        ...
                        <p className="lead mb-0">
                          ...
                          by blockchain technology on Dnerochain.
                        </p>
                      </div>
                    </div>
                  </div>
